...
const BackGroundColors = [Colors.primary, Colors.secondary, Colors.primaryDark];
  ...
  return (
    <Animated.View style={[styles.onboardingItem]}>
      ...
      <Animated.View style={textStyle}>
        <VText align="center" color={Colors.white} fontSize="large">
          {item.title}
        </VText>
        <Padding paddingTop={20} paddingHorizontal={20}>
          <VText color={Colors.white} align="center">
            {item.description}
          </VText>
        </Padding>
      </Animated.View>
